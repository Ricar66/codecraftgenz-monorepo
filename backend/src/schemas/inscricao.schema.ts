...
export const createInscricaoSchema = z.object({
  body: z.object({
    ...
    rede_social: z.string().max(500).optional(),
    cep: z.string().max(10).optional(),
    cidade: z.string().max(100).optional(),
    estado: z.string().max(2).optional(),
    area_interesse: z.string().max(100).optional(),
    rede_social_tipo: z.string().max(50).optional(),
    rede_social_user: z.string().max(200).optional(),
